import{i as M,a as i,A as I,S as P,N as F,P as R}from"./assets/vendor-B8rI0ALB.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const o of a)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function s(a){const o={};return a.integrity&&(o.integrity=a.integrity),a.referrerPolicy&&(o.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?o.credentials="include":a.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(a){if(a.ep)return;a.ep=!0;const o=s(a);fetch(a.href,o)}})();const C="https://furniture-store-v2.b.goit.study/api",T=8,u={CATEGORIES:"categories",FURNITURES:"furnitures",ORDERS:"orders",FEEDBACKS:"feedbacks"},_="/Project-CreativeTeam02/assets/1all_products-MNNrO4G5.jpg",A="/Project-CreativeTeam02/assets/7kitchens-B1U2sumV.jpg",H="/Project-CreativeTeam02/assets/10furniture_hallway-SzlnEjvC.jpg",O="/Project-CreativeTeam02/assets/12garden_furnitures-BsCHdeVT.jpg",N="/Project-CreativeTeam02/assets/5tables-DczJP-_Y.jpg",x="/Project-CreativeTeam02/assets/2sofas-CtxhA9kI.jpg",D="/Project-CreativeTeam02/assets/8child_furniture-DHKm76Ju.jpg",U="/Project-CreativeTeam02/assets/13accessoires-BnjU54Dx.jpg",z="/Project-CreativeTeam02/assets/11furniture_washrooms-tNgqFRxh.jpg",G="/Project-CreativeTeam02/assets/9office_furnitures-BLI04jhG.jpg",V="/Project-CreativeTeam02/assets/3wardrobe-BspX3wmj.jpg",K="/Project-CreativeTeam02/assets/4beds-D6hwExXz.jpg",J="/Project-CreativeTeam02/assets/6chairs-3pofB28T.jpg",r={categoryList:document.querySelector(".furniture-categories-list"),furnitureList:document.querySelector(".furniture-list"),loader:document.querySelector(".loader"),loadButton:document.querySelector(".button-load-more-furnitures"),feedbackSwiper:document.querySelector(".feedback-swiper"),modalBackdrop:document.querySelector(".modal-furniture-backdrop"),modalGallery:document.querySelector(".modal-furniture-gallery"),modalInfo:document.querySelector(".modal-furniture-info"),makeOrderButton:document.querySelector(".modal-furniture-btn"),orderModal:document.querySelector(".backdrop"),orderModalForm:document.querySelector(".modal-form")};var S;r.feedbackWrapper=(S=r.feedbackSwiper)==null?void 0:S.querySelector(".swiper-wrapper");const y={all:_,"66504a50a1b2c3d4e5f6a7bd":A,"66504a50a1b2c3d4e5f6a7c0":H,"66504a50a1b2c3d4e5f6a7c2":O,"66504a50a1b2c3d4e5f6a7bb":N,"66504a50a1b2c3d4e5f6a7b8":x,"66504a50a1b2c3d4e5f6a7be":D,"66504a50a1b2c3d4e5f6a7c3":U,"66504a50a1b2c3d4e5f6a7c1":z,"66504a50a1b2c3d4e5f6a7bf":G,"66504a50a1b2c3d4e5f6a7b9":V,"66504a50a1b2c3d4e5f6a7ba":K,"66504a50a1b2c3d4e5f6a7bc":J},v=document.querySelector('[for="modal-order-name"]'),b=document.querySelector('[name="user-name"]'),h=document.querySelector(".name-required-message"),L=document.querySelector('[name="modal-order-tel"]'),k=document.querySelector('[for="modal-order-tel"]'),w=document.querySelector(".tel-required-message"),W=()=>{const e=document.querySelector(".furniture-categories-list-item");e&&e.classList.add("current-category")};function m(){r.orderModal.classList.remove("fade-in"),r.orderModal.classList.add("fade-out"),document.body.classList.remove("no-scroll"),setTimeout(()=>{r.orderModal.classList.remove("is-open"),r.orderModal.classList.remove("fade-out"),document.body.style.overflow=""},300)}const X=document.querySelector(".modal-close-btn");X.addEventListener("click",m);r.orderModal.addEventListener("click",e=>{e.target.classList.contains("backdrop")&&m()});document.addEventListener("keydown",e=>{e.key==="Escape"&&m()});const Y=async e=>{e.preventDefault();const t=e.target.elements["user-name"].value.trim(),s=e.target.elements["modal-order-tel"].value.trim();let n=!1;t.length===0?(v.classList.add("error-label"),b.classList.add("error-input"),h.classList.remove("visually-hidden"),n=!0):(v.classList.remove("error-label"),b.classList.remove("error-input"),h.classList.add("visually-hidden")),s.length===0?(k.classList.add("error-label"),L.classList.add("error-input"),w.classList.remove("visually-hidden"),n=!0):(k.classList.remove("error-label"),L.classList.remove("error-input"),w.classList.add("visually-hidden")),!n&&(m(),r.orderModalForm.reset(),M.success({message:"Your order successfully created",position:"topRight",timeout:4e3,progressBar:!0,close:!0,transitionIn:"fadeInUp",transitionOut:"fadeOut",backgroundColor:"#4CAF50",messageColor:"#fff"}))};i.defaults.baseURL=C;let j=1;const Q=()=>j+=1,E=()=>j,Z=async()=>{const{data:e}=await i(`${u.CATEGORIES}`);return e},f=async(e=1,t=null)=>{const{data:s}=await i(`${u.FURNITURES}`,{params:{limit:T,page:e,category:t}});return console.log(s),s};async function ee(e){try{return(await i(`${u.FURNITURES}/${e}`)).data}catch{}}r.loader.classList.add("visually-hidden");const te=e=>{const t=e.map(s=>typeof s=="string"?`
  ...
  `;r.modalGallery.innerHTML=t;const s=e.color.map((c,q)=>`
        <label class="modal-furniture-color ">
          <input class="modal-furniture-color-input" type="radio" name="color-${e._id}" value="${c}" style="accent-color: ${c}" ${q===0?"checked":""} />
